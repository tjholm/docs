The Secrets service provides applications with the ability to securely store and retrieve application secrets.
...
> You can always use version 'latest' or 'latest()' on a secret rerference to get the latest version of a secret
